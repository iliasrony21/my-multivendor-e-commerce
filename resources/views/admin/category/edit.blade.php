								      ...
								      @csrf
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary msg">
												<input type="text" name="category_name" id="category_name" class="form-control @error('category_name') is-invalid @enderror" placeholder="category Name" value="{{ $category->category_name }}" />
                                        ...
                                        <div class="row mb-3">
											...
											<img id="imagepre" src="{{ !empty(asset('uploads/category/'.$category->category_image)) ? asset('uploads/category/'.$category->category_image) :asset('uploads/empty.jpg') }}" alt="category" height="150" width="150">
