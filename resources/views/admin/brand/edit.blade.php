								      ...
								      @csrf
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary msg">
												<input type="text" name="brand_name" id="brand_name" class="form-control @error('brand_name') is-invalid @enderror" placeholder="Brand Name" value="{{ $brand->brand_name }}" />

                                            </div>
										</div>
                                        <div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Choose brand Image</h6>
											</div>
											<div class="col-sm-9 text-secondary msg">
                                            <input type="file" name="brand_image" id="brand_image" class="form-control brand_image" value="" />
											<img id="imagepre" src="{{ !empty(asset('uploads/brand/'.$brand->brand_image)) ? asset('uploads/brand/'.$brand->brand_image) :asset('uploads/empty.jpg') }}" alt="brand" height="150" width="150">
