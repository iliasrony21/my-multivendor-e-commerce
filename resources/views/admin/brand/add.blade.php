								      ...
								      @csrf
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary msg">
												<input type="text" name="brand_name" id="brand_name" class="form-control @error('brand_name') is-invalid @enderror" placeholder="Brand Name" value="" />
                                        ...
                                        <div class="row mb-3">
											...
											<img id="imagepre" src="{{ asset('uploads/empty.jpg') }}" alt="brand" height="150" width="150">
