					...
					<div class="main-body">
						<div class="row">
							...
							<div class="col-lg-12">
                                ...
                                <div class="card">
									<div class="card-body">
                                    <form action="{{ route('vendor.activate.approve') }}" method="POST">
								      @csrf
									  ...
									  <input type="hidden" name="id" value="{{ $inactiveVendorDetails->id }}">
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9">
                                                ...
                                                <input type="datetime-local" name="vendor_join" value="{{$inactiveVendorDetails->vendor_join}}" class="form-control">
                                             </div>
										</div>
                                        <div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" name="vendor_short_info"   id="vendor_short_info" placeholder="vendor description" rows="3"> {{ $inactiveVendorDetails->vendor_short_info }}</textarea>											</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
                                                ...
                                                <img id="image" src="{{ (!empty('$inactiveVendorDetails->profile_pic')) ? asset('uploads/vendor/'.$inactiveVendorDetails->profile_pic):asset('uploads/empty.jpg') }}" alt="vendor" height="120" width="120">
											</div>
										</div>
										<div class="row">
											<div class="col-sm-3"></div>
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-danger px-4" value="Actived Vendor" />
											</div>
										</div>
									</div>
                                    </form>
