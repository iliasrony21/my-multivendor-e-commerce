                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="{{ route('wishlist') }}">
                                        ...
                                        <span class="pro-count blue" id="wqty">0</span>
                                    </a>
                                ...
                                <div class="header-action-icon-2">
                                    <a href="page-account.html">
                                        <img style="border-radius: 50%;" class="svgInject"  src="{{ (!empty($userData->profile_pic))? asset('uploads/user/'.$userData->profile_pic) : asset('uploads/user/user.png') }}" alt="" height="30" width="30" />
                                    </a>
                                    @auth
                                    ...
                                    @else
                                    <a href="{{ route('login') }}"><span class="lable ml-0">UserLogin  </span></a>
                                    <a href="{{ route('register') }}"><span class="lable ml-0">/ Register </span></a>
                                    <a href="page-account.html">
                                        <img class="svgInject" alt="Nest" src="{{asset('frontend')}}/assets/imgs/theme/icons/icon-user.svg" />
                                    </a>
                                    <a href="{{ route('admin.login') }}"><span class="lable ml-0">AdminLogin  </span></a>
                                    <a href="page-account.html">
                                        <img class="svgInject" alt="Nest" src="{{asset('frontend')}}/assets/imgs/theme/icons/icon-user.svg" />
                                    </a>
                                    <a href="{{ route('vendor.login') }}"><span class="lable ml-0">VendorLogin</span></a>
                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    ...
                                    @foreach($categories as $item)
                                        <li>
                                            <a href="shop-grid-right.html">
                                                <img src="{{ asset( 'uploads/category/'.$item->category_image ) }}" alt="image" />
                                                {{ $item->category_name }}
                                             </a>
                                        </li>
                                    @endforeach
                                    ...
                                    @foreach($categories as $item)
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{ asset( 'uploads/category/'.$item->category_image ) }}" alt="image" />{{ $item->category_name }}</a>
                                        </li>
                                    @endforeach
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ url('category/details/'.$category->id.'/'.$category->category_slug) }}">{{ $category->category_name }} <i class="fi-rs-angle-down"></i></a>
                                        @php
                                        $subcategories = App\Models\SubCategory::where('category_id', $category->id)->orderBy('subcategory_name','ASC')->get();
                                        @endphp
                                        <ul class="sub-menu">
                                            @foreach($subcategories as $subcategory)
                                            <li><a href="{{ url('subcategory/details/'.$subcategory->id.'/'.$subcategory->subcategory_slug) }}">{{ $subcategory->subcategory_name }}</a></li>
