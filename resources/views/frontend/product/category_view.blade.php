            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <h1 class="mb-15">{{ $catname->category_name }}</h1>
                            <div class="breadcrumb">
                                <a href="index.html" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span>{{ $catname->category_name }}
                            </div>
                        </div>
                ...
                <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            ...
                            @endphp
                            <li>
                                <a href="{{ url('category/details/'.$category->id.'/'.$category->category_slug) }}"> <img src="{{ asset('uploads/category/'.$category->category_image) }}" alt="" />{{$category->category_name}}s</a><span class="count">{{ count($products) }}</span>
                            </li>
                           @endforeach
                        </ul>
                    </div>
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <p><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}">{{$product->product_name}}</a></p>
                                               ...
                                               <p class="price mb-0 mt-5 text-decoration-line-through ">${{ $product->selling_price }}</p>
                                               @endif
