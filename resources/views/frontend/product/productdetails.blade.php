                        ...
                        <div class="row mb-50 mt-30">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                @endif
                                    ...
                                    <h6>Sold By <span class="text-danger">Admin</span></h6>
                                    @else
...
<div class="font-xs">
    ...
    <ul class="float-start">
        ...
        <li class="mb-5">Tags: <a href="#" rel="tag">Snack</a>, <a href="#" rel="tag">{{ $product->product_tags }}</a>, <a href="#" rel="tag">Brown</a></li>
                            ...
                            <div class="tab-style3">
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        ...
                                        <img src="{{ (!empty($product->vendor->profile_pic)) ? url('uploads/vendor/'.$product->vendor->profile_pic):url('uploads/empty.jpg') }}" alt="" />
...
<div class="single-comment justify-content-between d-flex mb-30">
    <div class="user justify-content-between d-flex">
        <div class="thumb text-center">
            <img src="{{ (!empty($item->user->profile_pic)) ? url('uploads/user/'.$item->user->profile_pic):url('uploads/empty.jpg') }}" alt="" />
