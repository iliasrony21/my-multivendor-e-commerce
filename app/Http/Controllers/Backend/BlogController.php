...
class BlogController extends Controller
{
    public function AllBlogCategory(){
        ...
        return view('admin.blog.category.blogcategory_all',compact('blogcategories'));

    } // End Method

    public function AddBlogCategory(){
        return view('admin.blog.category.blogcategory_add');
    } // End Method
    ...
    public function EditBlogCategory($id){
        ...
        return view('admin.blog.category.blogcategory_edit',compact('blogcategories'));
